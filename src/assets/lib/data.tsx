...
export const headerIntroData = {
  ...
  description: {
    ...
    en: "I'm Hamad, a MERN Stack developer with the goal of advancing my career and participating in inspiring projects. Here I present my work and my passion for web development. Let's shape digital solutions together and shape the future!",
  },
  buttons: [
    {
      name: "Contact",
...
export const projectsData = [
...

  {
    ...
    description:
      "Eine Möbel-Organizer App, die wir als Duo-Team mit React, MongoDB, Express und Node.js programmiert haben. Als Gitmaster habe ich die Verknüpfung des Frontends mit dem Backend und die Datenbankmodellierung übernommen. Die App ist responsive und mobile-optimiert.",
    description_EN:
      "A sleek, real-time weather forecasting app that provides accurate weather updates based on your location.",
    technologies: [
      { name: "Html", icon: htmlicon },
      { name: "CSS", icon: cssicon },
      { name: "JavaScript", icon: javascripticon },
    ...
    image: weather,
    deploymenturl: "https://weather-app-lemon-two-87.vercel.app/",
    githuburl: "https://github.com/HQ447/vistaMovies.git",
    githubicon: FiGithub,
    deploymenticon: FiLink,
    colors: {
...
export const sideBarRightMail = {
  link: "mailto:hamadqur44@gmail.com",
  text: "hamadqur44@gmail.com",
} as const;

export const sideBarLeftSocials = [
  {
    link: "https://www.linkedin.com/in/hammad-ahmad-hq447",
    icon: FiLinkedin,
    altimgname: "linkedin",
  },
  {
    link: "https://github.com/hq447",
    icon: FiGithub,
    altimgname: "github",
  },
  {
